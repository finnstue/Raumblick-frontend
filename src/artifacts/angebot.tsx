...
const CustomerQuote: React.FC<CustomerQuoteProps> = ({ quoteId = "Q2024-001" }) => {
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden p-8 text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Wir haben Ihre Vorschläge erhalten und werden diese sorgfältig prüfen.
            </p>
          </div>
          
          <div className="space-y-4 mb-8">
            <p className="text-gray-600">
              Unser Team wird sich innerhalb der nächsten 48 Stunden mit einem aktualisierten Angebot bei Ihnen melden.
            </p>
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="bg-blue-600 text-white px-8 py-6">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-2xl font-bold">Angebot #{quoteData.quote.number}</h1>
                <p className="mt-1 text-blue-100">
                  Erstellt am {new Date(quoteData.quote.date).toLocaleDateString()}
                </p>
              </div>
          ...
          <div className="p-8">
            ...
            {/* 3D Preview */}
            <div className="mb-8">
              <h3 className="text-sm font-medium text-gray-500 mb-3">Visualisierung</h3>
            ...
            {/* Products List */}
            <div className="mb-8">
              <h3 className="text-sm font-medium text-gray-500 mb-3">Produkte</h3>
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {quoteData.quote.items.slice(0, showAllProducts ? undefined : 2).map((item) => (
                      <tr key={item.id}>
                  ...
                  <tfoot className="bg-gray-50">
                    ...
                    <tr>
                      <td colSpan={3} className="px-6 py-3 text-lg font-bold text-gray-900 text-right">
                        Gesamtbetrag
                      </td>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 mb-2">Geschäftsbedingungen</h4>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Dieses Angebot ist gültig bis zum {new Date(quoteData.quote.validUntil).toLocaleDateString()}</li>
      ...
      {showChangesForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-lg w-full p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-xl font-medium text-gray-900">Änderungen vorschlagen</h3>
              <button
